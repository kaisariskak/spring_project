...
public class PkiSignatureChecker {
    ...
    private final String ocspServiceUrl = "http://ocsp.pki.gov.kz";
    ...
    private void checkBin(X509Certificate certificate, String binNo) throws UsciException, IOException, CertificateParsingException {
