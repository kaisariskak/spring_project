...
/**
 * Справочник признаков исключения/условного исключения физического
 * лица из
 *                         Национального реестра ИИН
 */
public class ExcludeReason  implements java.io.Serializable {
    ...
    /**
     * Gets the code value for this ExcludeReason.
     * 
    ...
    /**
     * Sets the code value for this ExcludeReason.
     * 
    ...
    /**
     * Gets the nameRu value for this ExcludeReason.
     * 
    ...
    /**
     * Sets the nameRu value for this ExcludeReason.
     * 
    ...
    /**
     * Gets the nameKz value for this ExcludeReason.
     * 
    ...
    /**
     * Sets the nameKz value for this ExcludeReason.
     * 
    ...
    /**
     * Gets the changeDate value for this ExcludeReason.
     * 
    ...
    /**
     * Sets the changeDate value for this ExcludeReason.
     * 
    ...
    public synchronized boolean equals(Object obj) {
        if (!(obj instanceof ExcludeReason)) return false;
        ExcludeReason other = (ExcludeReason) obj;
    ...
    private static org.apache.axis.description.TypeDesc typeDesc =
        new org.apache.axis.description.TypeDesc(ExcludeReason.class, true);

    static {
        typeDesc.setXmlType(new javax.xml.namespace.QName("http://dictionaries.persistence.interactive.nat", "ExcludeReason"));
