...
public class X509DataType  implements java.io.Serializable, org.apache.axis.encoding.AnyContentType {
    private gbdul.org.w3.www._2000._09.xmldsig.X509IssuerSerialType x509IssuerSerial;
    ...
    public X509DataType(
           gbdul.org.w3.www._2000._09.xmldsig.X509IssuerSerialType x509IssuerSerial,
           byte[] x509SKI,
     ...
     */
    public gbdul.org.w3.www._2000._09.xmldsig.X509IssuerSerialType getX509IssuerSerial() {
        return x509IssuerSerial;
    }
     ...
     */
    public void setX509IssuerSerial(gbdul.org.w3.www._2000._09.xmldsig.X509IssuerSerialType x509IssuerSerial) {
        this.x509IssuerSerial = x509IssuerSerial;
    }
    ...
    public synchronized int hashCode() {
        ...
        if (getX509SKI() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getX509SKI(), i);
                if (obj != null &&
        ...
        if (getX509Certificate() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getX509Certificate(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
        ...
        if (getX509CRL() != null) {
            for (int i=0;
                 ...
                 i++) {
                Object obj = java.lang.reflect.Array.get(getX509CRL(), i);
                if (obj != null &&
                    !obj.getClass().isArray()) {
                    _hashCode += obj.hashCode();
                }
