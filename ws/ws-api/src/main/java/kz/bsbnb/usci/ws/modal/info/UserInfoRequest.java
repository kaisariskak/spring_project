...
@JacksonXmlRootElement(
        localName = "UserInfoRequest",
        namespace = "http://usci.bsbnb.kz/ws/schema"
)
@Schema(name = "UserInfoRequest",  description =  "Основной XML-запрос, передаваемый в USCI. " +
        "Содержит информацию о пользователе, отчетная дата, код продукта , код банка")
